...
module.exports = calcBox = (function() {
  ...
  calcBox.prototype._pushParcel = function(parcel, suitableSideOfBox) {
    var boxSides, longestSideOfBox, longestSideOfPrcel, parcelSides, shortestSideOfBox, shortestSideOfPrcel;
    ...
    if (longestSideOfPrcel.value > shortestSideOfBox.value) {
      this[shortestSideOfBox.side] -= shortestSideOfPrcel.value;
    } else {
      this[longestSideOfBox.side] -= shortestSideOfPrcel.value;
    }
    return true;
  };
